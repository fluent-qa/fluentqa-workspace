...
import static io.fluent.datafactory.core.TestTable.TestTableAssert.assertThat;
import static io.fluent.datafactory.core.TestTable.buildUniqueTable;
...
public class PostgreSqlTest {
  ...
  @Test
  public void should_generate_working_insert_from_a_select_statement() {
    ...
    assertThat(playerTable)
        ...
        .row(0)
        .column(1)
        .hasValues("Paul", "Antoine")
        .row(0)
        .column(2)
        .hasValues("Pogba", "Griezmann");
  }
  ...
  @Test
  public void should_generate_an_insert_with_selected_columns_only() {
  ...
  public void should_generate_an_insert_statement_with_not_null_columns() {
    ...
    String select = "SELECT id FROM " + playerTable.getTableName() + " WHERE lastName = 'Pogba'";
  ...
  @RepeatedTest(9)
  public void should_sort_insert_statements_following_primary_keys() {
  ...
  @Test
  public void should_generate_an_insert_statement_with_a_date_type() {

    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "date Date").create().insertValues("'2012-09-17'");
    ...
    assertThat(playerTable)
        ...
        .hasNumberOfRows(1)
        .row(0)
        .hasValues("2012-09-17");
  }

  @Test
  public void should_generate_an_insert_statement_with_a_timestamp_type() {

    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "timestampCol TIMESTAMP")
            .create()
  ...
  @Test
  public void should_generate_an_insert_statement_with_a_timestamp_with_time_zone_type() {

    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "col TIMESTAMP WITH TIME ZONE")
            .create()
  ...
  @Test
  public void should_generate_an_insert_statement_with_a_time_type() {

    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "col TIME").create().insertValues("'23:59:59'");
  ...
  @Test
  public void should_generate_an_insert_statement_with_a_time_with_timezone_type() {

    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "col TIME WITH TIME ZONE")
            .create()
