...
@XmlType(
    name = "",
    propOrder = {"arrowlinkOrAttributeOrAttributeLayout"})
...
public class Node {
   ...
   * there is not a <CODE>set</CODE> method for the arrowlinkOrAttributeOrAttributeLayout property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Arrowlink } {@link Attribute
   * } {@link AttributeLayout } {@link Linktarget } {@link Cloud } {@link Edge } {@link Font }
   * {@link Hook } {@link Icon } {@link Node } {@link Richcontent }
   */
