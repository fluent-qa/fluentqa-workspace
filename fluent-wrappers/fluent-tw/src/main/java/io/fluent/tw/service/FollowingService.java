...
public class FollowingService {
     ...
     * URL: https://developer.twitter.com/en/docs/twitter-api/users/follows/api-reference/get-users-id-following#tab0
     *
     * @return
     */
    public UsersFollowingLookupResponse getFollowingList(String userId, int maxResult,
                                                         String pagination_token, int retries) {
        try {
