...
public class TransitionConfig {
  ...
  private Map<String, Map<String, String>> customFieldsToCopyFromTargetToSource =
      new LinkedHashMap<>();
  ...
  public void setTriggerIfIssueWasMovedBetweenProjects(
      boolean triggerIfIssueWasMovedBetweenProjects) {
    this.triggerIfIssueWasMovedBetweenProjects = triggerIfIssueWasMovedBetweenProjects;
  }

  public void setCustomFieldsToCopyFromTargetToSource(
      Map<String, Map<String, String>> customFieldsToCopyFromTargetToSource) {
  ...
  private Map<String, String> getCustomFieldsToCopyFromTargetToSource(JiraIssueType issueType) {
    return getCustomFieldsToCopyFromTargetToSource()
        .getOrDefault(issueType.getName(), Collections.emptyMap());
  }
