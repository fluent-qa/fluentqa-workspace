package io.fluent.datafactory.core.support.factory;

import com.github.houbb.heaven.util.lang.ObjectUtil;
import com.github.houbb.heaven.util.lang.reflect.ClassTypeUtil;
import com.github.houbb.heaven.util.util.MapUtil;
import io.fluent.datafactory.api.core.IData;
import io.fluent.datafactory.core.api.data.aggregate.*;
import io.fluent.datafactory.core.api.data.lang.*;
import io.fluent.datafactory.core.api.data.math.*;
import io.fluent.datafactory.core.api.data.primitive.*;
import io.fluent.datafactory.core.api.data.time.*;
import io.fluent.datafactory.core.api.data.util.CurrencyData;
import io.fluent.datafactory.core.api.data.util.DateData;
import io.fluent.datafactory.core.util.DataClassUtil;
...
public final class DataFactoryMapping {
  ...
  /**
   * 初始化数据工厂 这种写法虽然优雅，但是总会有用户不开启运行时注解。
   *
   * @since 0.0.5
   */
  @Deprecated
    ...
    synchronized (DATA_CLASS_MAP) {
      ...
      for (IData data : dataLoader) {
        ...
        if (isDataFactoryClass(clazz)) {
          ...
          System.out.println(
              String.format(
                  "DATA_CLASS_MAP.put(%s.class, new %s());",
                  genericType.getSimpleName(), data.getClass().getSimpleName()));
