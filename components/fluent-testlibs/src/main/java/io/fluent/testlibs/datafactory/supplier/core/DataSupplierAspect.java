...
public class DataSupplierAspect {
    ...
    private static final List<DataSupplierInterceptor> DATA_SUPPLIERS =
        ServiceLoaderUtils.load(DataSupplierInterceptor.class, DataSupplierAspect.class.getClassLoader());
    private static final List<IAnnotationTransformerInterceptor> ANNOTATION_TRANSFORMERS =
        ServiceLoaderUtils.load(IAnnotationTransformerInterceptor.class, DataSupplierAspect.class.getClassLoader());
