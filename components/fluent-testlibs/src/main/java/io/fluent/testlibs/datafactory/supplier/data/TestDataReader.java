...
/**
 * Generic structure for reading test data in JSON, CSV and YAML formats. Each format has it's own
 * implementation, which should be passed to {@link #use(Class)} method.
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * Please note that {@link io.github.sskorol.data.TestDataReader.DataBuilder#withSource(String)} is
 * optional. But if it's skipped, you have to use {@link Source} annotation to define source path.
 *
