...
public final class FileOptionConst {
  ...
  /**
   * 打开以便读取和写入。相对于 "rw"，"rws" 还要求对“文件的内容”或“元数据”的每个更新都同步写入到基础存储设备。 适用场景：安全性要求较高，文件内容不大，debug 模式。
  ...
  /** 打开以便读取和写入，相对于 "rw"，"rwd" 还要求对“文件的内容”的每个更新都同步写入到基础存储设备 备注：介于 rw-rws 中间。个人暂时比较倾向于这种方式。 */
