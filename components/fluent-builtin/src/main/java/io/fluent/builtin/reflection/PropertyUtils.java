...
public final class PropertyUtils {
  ...
  private static final ClassValue<PropertyDescriptorCache<?>> cache =
      ClassValues.create(PropertyDescriptorCache::new);
  ...
  @Nullable
  public static PropertyDescriptor getPropertyDescriptorByName(
  ...
  @NotNull
  public static PropertyDescriptor getPropertyDescriptorByNameOrThrow(
  ...
  public static PropertyDescriptor getPropertyDescriptorByNameOrThrow(
    ...
    Assert.notNull(
        ...
        () ->
            String.format(
                "Property '%s' not found for '%s'", propertyName, beanClass.getSimpleName()));
  ...
  public static <A extends Annotation>
      Map<PropertyDescriptor, A> getPropertyDescriptorsWithAnnotation(
          Class<?> type, Class<A> annotationClass) {
    PropertyDescriptorCache<?> propertyDescriptorCache = getCache(type);
  ...
  public static <T> T copyNonDefaultValues(
      T source, T destination, PropertyDescriptor... excludedProperties) {
    return copyNonDefaultValues(
        source, destination, Stream.of(excludedProperties).collect(Collectors.toSet()));
  }

  public static <T> T copyNonDefaultValues(
      T source, T destination, Collection<PropertyDescriptor> excludedProperties) {
  ...
  public static <T> Object copyValue(
      T source, T destination, PropertyDescriptor propertyDescriptor) {
  ...
  public static <T> boolean isDefaultValue(
      Class<T> objectClass, TypedPropertyGetter<T, ?> propertyGetter, Object value) {
    return isDefaultValue(objectClass, getPropertyDescriptor(objectClass, propertyGetter), value);
  }

  public static <T> boolean isDefaultValue(
      Class<T> objectClass, PropertyDescriptor propertyDescriptor, Object value) {
  ...
  public static <T> Object getDefaultValue(
  ...
  public static void write(Object destination, String propertyName, Object value) {
    PropertyDescriptor propertyDescriptor =
        getPropertyDescriptorByNameOrThrow(destination, propertyName);
    write(destination, propertyDescriptor, value);
  }

  public static <T> void writeIfPropertyExists(
      Object destination, String propertyName, Supplier<T> valueSupplier) {
  ...
  public static void write(
      Object destination, PropertyDescriptor propertyDescriptor, Object value) {
    write(destination, propertyDescriptor, value, false);
  }

  public static void write(
      Object destination, PropertyDescriptor propertyDescriptor, Object value, boolean force) {
    try {
      ...
      throw new ReflectionRuntimeException(
          "Failed to write " + getQualifiedPropertyName(destination, propertyDescriptor), e);
    }
  }

  public static void writeDirectly(
      Object destination, PropertyDescriptor propertyDescriptor, Object value) {
  ...
  public static void writeDirectly(Object destination, String propertyName, Object value) {
    try {
      ...
      throw new ReflectionRuntimeException(
          "Failed to write " + getQualifiedPropertyName(destination, propertyName), e);
    }
  }
  ...
  public static void writeDirectly(Object destination, Field field, Object value) {
    ...
    try {
      ...
      throw new ReflectionRuntimeException(
          "Failed to write " + getQualifiedPropertyName(destination, field), e);
    }
  }

  private static Field findField(Class<?> objectClass, String propertyName)
  ...
  public static <T> T readDirectly(Object object, String propertyName) {
    try {
      ...
      throw new ReflectionRuntimeException(
          "Failed to read " + getQualifiedPropertyName(object, propertyName), e);
    }
  }

  public static <T> T readDirectly(Object object, Field field) {
    try {
      return withAccessibleObject(
          field,
          f -> {
            @SuppressWarnings("unchecked")
      ...
      throw new ReflectionRuntimeException(
          "Failed to read " + getQualifiedPropertyName(object, field), e);
    }
  }
  ...
  public static <T> T read(Object source, PropertyDescriptor propertyDescriptor, boolean force) {
    ...
    try {
      if (!isReadable(propertyDescriptor)) {
        if (force) {
          ...
          throw new IllegalArgumentException(
              String.format("%s must be readable", propertyDescriptor.getName()));
        }
      } else {
      ...
      throw new ReflectionRuntimeException(
          "Failed to read " + getQualifiedPropertyName(source, propertyDescriptor), e);
    }
    @SuppressWarnings("unchecked")
  ...
  public static <T> T readProperty(
      Object entity, PropertyDescriptor propertyDescriptor, Class<T> expectedType) {
    ...
    if (!expectedType.isAssignableFrom(propertyType)) {
      throw new IllegalArgumentException(
          String.format(
              "%s.%s is of type %s but %s is expected",
              clazz, propertyName, propertyType, expectedType));
    }
    return PropertyUtils.read(entity, propertyDescriptor);
  }

  @NotNull
  public static <T> PropertyDescriptor getPropertyDescriptor(
      T bean, TypedPropertyGetter<T, ?> propertyGetter) {
  ...
  @NotNull
  public static <T> PropertyDescriptor getPropertyDescriptor(
      Class<T> beanClass, TypedPropertyGetter<T, ?> propertyGetter) {
    ...
    Assert.notNull(
        propertyDescriptor,
        () -> String.format("Found no property for %s on %s", method, beanClass));
    return propertyDescriptor;
  }

  @NotNull
  public static <T> String getPropertyName(
      Class<T> beanClass, TypedPropertyGetter<T, ?> propertyGetter) {
  ...
  @Nullable
  public static <T> PropertyDescriptor getPropertyDescriptorByMethod(
  ...
  @Nullable
  public static <T> PropertyDescriptor getPropertyDescriptorByField(
      Class<T> beanClass, Field field) {
    PropertyDescriptorCache<?> propertyDescriptorCache = getCache(beanClass);
  ...
  public static <T> Method findMethodByGetter(
      Class<T> beanClass, TypedPropertyGetter<T, ?> propertyGetter) {
  ...
  public static boolean hasAnnotationOfProperty(
      Class<?> entityType,
  ...
  public static <T, A extends Annotation> A getAnnotationOfProperty(
      Class<T> entityType, TypedPropertyGetter<T, ?> propertyGetter, Class<A> annotationClass) {
  ...
  public static <A extends Annotation> A getAnnotationOfProperty(
      Object object, PropertyDescriptor descriptor, Class<A> annotationClass) {
    Class<Object> objectClass = ClassUtils.getRealClass(object);
    return getAnnotationOfProperty(objectClass, descriptor, annotationClass);
  }

  public static <A extends Annotation> A getAnnotationOfProperty(
      Class<?> entityType, PropertyDescriptor descriptor, Class<A> annotationClass) {
    PropertyDescriptorCache<?> cache = getCache(entityType);
    Map<PropertyDescriptor, A> descriptorsForAnnotation =
        cache.getDescriptorsForAnnotation(annotationClass);
  ...
  public static boolean isDeclaredInClass(
      PropertyDescriptor propertyDescriptor, Class<?> entityClass) {
    Method readMethod = propertyDescriptor.getReadMethod();
  ...
  public static <T> String getQualifiedPropertyName(
      T bean, TypedPropertyGetter<T, ?> propertyGetter) {
    Class<T> beanClass = ClassUtils.getRealClass(bean);
  ...
  public static <T> String getQualifiedPropertyName(
      Class<T> type, TypedPropertyGetter<T, ?> propertyGetter) {
  ...
  public static String getQualifiedPropertyName(
  ...
  public static String getQualifiedPropertyName(
      Class<?> type, PropertyDescriptor propertyDescriptor) {
  ...
  private static <T extends AccessibleObject> void withAccessibleObject(
      T accessibleObject, AccessibleObjectConsumer<T> accessibleObjectConsumer)
      throws ReflectiveOperationException {
    withAccessibleObject(
        accessibleObject,
        obj -> {
  ...
  private static <T extends AccessibleObject, R> R withAccessibleObject(
      T accessibleObject, AccessibleObjectFunction<T, R> function, boolean force)
      throws ReflectiveOperationException {
