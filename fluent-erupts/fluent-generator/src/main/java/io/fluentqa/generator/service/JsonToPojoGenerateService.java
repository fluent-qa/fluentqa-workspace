...
public class JsonToPojoGenerateService {
  ...
  public void generate(String schemaFile, String packageName, String className, String outputDir)
      throws IOException {
    ...
    Arguments config =
        new Arguments() {
          ...
          public Iterator<URL> getSource() {
            return Lists.newArrayList(source).iterator();
          }
    ...
    Jsonschema2Pojo.generate(config, new CommandLineLogger("info"));
  }
}
