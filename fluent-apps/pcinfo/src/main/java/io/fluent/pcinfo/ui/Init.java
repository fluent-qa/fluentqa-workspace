...
import io.fluent.pcinfo.ui.form.*;
import io.fluent.pcinfo.util.SystemUtil;
import io.fluent.pcinfo.util.UIUtil;
...
public class Init {
    ...
    public static void initGlobalFont() {
        if (StrUtil.isEmpty(App.config.getProps(FONT_SIZE_INIT_PROP))) {
