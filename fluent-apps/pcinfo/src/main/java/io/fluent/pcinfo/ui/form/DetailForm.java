...
import io.fluent.pcinfo.ui.Style;
import io.fluent.pcinfo.util.DateTimeUtil;
...
public class DetailForm {
    ...
    private static String getOsInfo() {
        ...
        builder.append("<br/><b>System Boot Time: </b>").append(DateTimeUtil.toReadableTime(operatingSystem.getSystemBootTime() * 1000));
